//
//  AccountCommandsDispatcher.swift
//  BitriseATV
//
...
final class AccountCommandsDispatcher {
    private let queue = DispatchQueue(label: "com.bitrise.account_commands_dispatcher")
...
extension AccountCommandsDispatcher {
